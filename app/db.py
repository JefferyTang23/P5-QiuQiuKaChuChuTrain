...
c.execute("CREATE TABLE IF NOT EXISTS school_events(name TEXT, message TEXT, choice0 TEXT, choice1 TEXT, aftermath00 TEXT, aftermath01 TEXT, aftermath1 TEXT, c00stat0c INTEGER, c00stat1c INTEGER, c00stat2c INTEGER, c00stat3c INTEGER, c01stat0c INTEGER, c01stat1c INTEGER, c01stat2c INTEGER, c01stat3c INTEGER, c1stat0c INTEGER, c1stat1c INTEGER, c1stat2c INTEGER, c1stat3c INTEGER, date TEXT )")
...
c.execute("INSERT into randc_events VALUES(?, ?, ?, ?, ?, ?,  ?, ?, ?, ?, ?, ?, ?, ?, ?  )", ('book', 'You see one of your teacher pushing a book cart in the hallway. A student walks by and accidentally knocked over the books.', 'Help pick books up', 'Walk away', 'Your teacher appreciates you.', 'You walked away in guilt.',  20, 5, 0, 3, 0, -5, 0, -3, 0  ))

c.execute("INSERT into school_events VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", ('StuySquad_2019', 'It\'s time for Stuy\'s annual dance show! Join StuySquad 2019?', 'Join', 'Don\'t take part', 'You helped put on an amazing show and met amazing people!', 'The show didn\'t go as planned but you still met a lot of cool people!', 'You chose not to take part', 30, -1, 20, 10, 20, -1, 12, 10, 0, 0, 0, 0, '19Oct0'))
c.execute("INSERT into school_events VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", ('StuySquad_2021', 'It\'s time for Stuy\'s annual dance show! Join StuySquad 2021?', 'Join', 'Don\'t take part', 'You helped put on an amazing show and met amazing people!', 'The show didn\'t go as planned but you still met a lot of cool people!', 'You chose not to take part', 30, -1, 20, 10, 20, -1, 12, 10, 0, 0, 0, 0, '21Oct0'))
c.execute("INSERT into school_events VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", ('StuySquad_2022', 'It\'s time for Stuy\'s annual dance show! Join StuySquad 2022?', 'Join', 'Don\'t take part', 'You helped put on an amazing show and met amazing people!', 'The show didn\'t go as planned but you still met a lot of cool people!', 'You chose not to take part', 30, -1, 20, 10, 20, -1, 12, 10, 0, 0, 0, 0, '2Oct0'))
c.execute("INSERT into school_events VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", ('SING_2020', 'It\'s time for Stuy\'s annual SING! Join SING 2020?', 'Join', 'Don\'t take part', 'You helped put on an amazing show and met amazing people!', 'The show didn\'t go as planned but you still met a lot of cool people!', 'You chose not to take part', 30, -1, 20, 10, 20, -1, 12, 10, 0, 0, 0, 0, '20Feb0'))
c.execute("INSERT into school_events VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", ('SING_2022', 'It\'s time for Stuy\'s annual SING! Join SING 2022?', 'Join', 'Don\'t take part', 'You helped put on an amazing show and met amazing people!', 'The show didn\'t go as planned but you still met a lot of cool people!', 'You chose not to take part', 30, -1, 20, 10, 20, -1, 12, 10, 0, 0, 0, 0, '22Feb0'))
c.execute("INSERT into school_events VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", ('SING_2023', 'It\'s time for Stuy\'s annual SING! Join SING 2023', 'Join', 'Don\'t take part', 'You helped put on an amazing show and met amazing people!', 'The show didn\'t go as planned but you still met a lot of cool people!', 'You chose not to take part', 30, -1, 20, 10, 20, -1, 12, 10, 0, 0, 0, 0, '23Feb0'))
c.execute("INSERT into school_events VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", ('SOS_2022', 'It\'s time for Stuy\'s annual showcase! Join SOS 2022?', 'Join', 'Don\'t take part', 'You helped put on an amazing show and met amazing people!', 'The show didn\'t go as planned but you still met a lot of cool people!', 'You chose not to take part', 30, -1, 20, 10, 20, -1, 12, 10, 0, 0, 0, 0, '22Apr1'))
c.execute("INSERT into school_events VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", ('SOS_2023', 'It\'s time for Stuy\'s annual showcase! Join SOS 2023?', 'Join', 'Don\'t take part', 'You helped put on an amazing show and met amazing people!', 'The show didn\'t go as planned but you still met a lot of cool people!', 'You chose not to take part', 30, -1, 20, 10, 20, -1, 12, 10, 0, 0, 0, 0, '23Apr1'))
